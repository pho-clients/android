...
public class JsonUtil {
  ...
  public static Type getListTypeForDeserialization(Class cls) {
    ...
    if ("Edge".equalsIgnoreCase(className)) {
      return new TypeToken<List<Edge>>(){}.getType();
    }
    ...
    if ("InlineResponse2003In".equalsIgnoreCase(className)) {
      return new TypeToken<List<InlineResponse2003In>>(){}.getType();
    }
    ...
    if ("NodeEdge".equalsIgnoreCase(className)) {
      return new TypeToken<List<NodeEdge>>(){}.getType();
    }
  ...
  public static Type getTypeForDeserialization(Class cls) {
    ...
    if ("Edge".equalsIgnoreCase(className)) {
      return new TypeToken<Edge>(){}.getType();
    }
    ...
    if ("InlineResponse2003In".equalsIgnoreCase(className)) {
      return new TypeToken<InlineResponse2003In>(){}.getType();
    }
    ...
    if ("NodeEdge".equalsIgnoreCase(className)) {
      return new TypeToken<NodeEdge>(){}.getType();
    }
